        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 text-center">
            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div className="border-2 border-white px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110 bg-transparent">
                <svg
                  fill="none"
                  stroke="currentColor"
                  strokeLinecap="round"
                  ...
                  strokeWidth="2"
                  className="text-rose-500 w-12 h-12 mb-3 inline-block"
                  viewBox="0 0 24 24"
                >
