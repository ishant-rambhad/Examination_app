...
//               search
//             </span>
//             <span className="material-icons-outlined p-2 text-2xl cursor-pointer hover:text-indigo-800 transition-transform duration-300 hover:scale-110 hidden md:block notification-icon">
//               notifications
//             </span>
//             <img
//               className="w-10 h-10 rounded-full transition-transform duration-300 hover:scale-110 object-cover"
...
//         {/* Sidebar */}
//         <aside
//           className={`fixed lg:static w-[240px] bg-indigo-50 h-[calc(100vh-4rem)] lg:h-auto transform transition-transform duration-300 z-45 overflow-y-auto p-4 ${
//             isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
//           }`}
//         >
//           <div className="bg-white rounded-xl shadow-lg mb-6 p-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
